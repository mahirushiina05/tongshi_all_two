  ...
  <section class="course-preview">
    <div class="container">
      <div class="section-header fade-up">
        ...
        <h2 class="section-title">六章全景，构建 AI 知识体系</h2>
      ...
      <div class="chapters-grid fade-up">
        <div
        ...
        >
          ...
          <div class="chapter-content">
            <div class="chapter-top">
              <span class="chapter-tag" v-html="ch.tag"></span>
              <span class="chapter-icon" v-html="ch.icon"></span>
            </div>
...
.chapter-card:hover .chapter-line {
  width: 100%;
}
